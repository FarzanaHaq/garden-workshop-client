          ...
          {user ? (
            <div>
              ...
              <Link
                ...
                className="btn btn-outline btn-primary text-[#01875F] border-[#01875F] border-2 text-[15px] hover:bg-white shadow-none"
              >
                Logout
              </Link>
            </div>
            ...
            <Link to="/login" className="">
              <button className=" btn border-[rgb(1,135,95)] text-[rgb(1,135,95)]  border-2 text-[15px] shadow-none outline-none focus:shadow-none focus:outline-none">
                Login
              </button>
            </Link>
          )}
